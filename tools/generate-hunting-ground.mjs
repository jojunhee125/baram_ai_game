 ...
 * door up to the north edge, widening into a trailhead around the spawn. The two blocks are read
 * together cell by cell, so a row that drifts out of alignment with the other block moves an
 * obstacle off its ground rather than failing - hence the checks further down.
 */
const INTERIOR_WIDTH = 40;
const INTERIOR_HEIGHT = 24;

const GROUND_ROWS = [
  "gggfgggggggggggggggddggggggggggggfgggggg",
